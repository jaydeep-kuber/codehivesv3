...
const options = [
  {
    title: <>What is CODE HIVES?</>,
    body: (
      <>
        CODE HIVES is the Official Coding Club of GEC Patan, Katpur.
        It works as an open-source organization like Git and Github. 
        Members here learn and collaborate to make their ideas into a solution/product. 
        It also organizes national level hackathons driven by the idea of making
        proof of concepts of great ideas using software.
      </>
    ),
  },
  {
    title: <>Who is the Professor-In-Charge of CODE HIVES?</>,
    body: (
      <>
        The Professor-In-Charge of CODE HIVES is Mr. Sachin Makwana Sir and Mr. Jay Patel Sir from
        the Dept. of Computer Science & Engineering, GEC Patan.
      </>
    ),
  },
  {
    title: <>Where does CODE HIVES operate from ?</>,
    body: (
      <>
        In college, CODE HIVES operates from CSE Building, GEC Patan, Gujrat-384285,
        now it is in operation via remote only
      </>
    ),
  },
  {
    title: <>What qualities are required at CODE HIVES ?</>,
    body: (
      <>
        To join CODE HIVES you have to:-
        <ul className="pl-8">
          <li>
          ...
          <li>
            Be patient. You have to prove your willingness to join CODE HIVES. We will
        ...
        <ul>
          ...
          <li>
            Learn digital art from the guidance of current CODE HIVES members and
  ...
  {
    title: <>What are some of the domains of CODE HIVES ?</>,
    body: (
      <>
        The domains of CODE HIVES are:-
        <ul>
  ...
  {
    title: <>What tasks do I need to do to land an interview for CODE HIVES ?</>,
    body: (
      <>
        Do at least one of the following:-
        <ul>
          <li>
            Get in touch with a member of CODE HIVES and ask him/her to refer you.
          ...
          <li>
            ...
            of CODE HIVES). In such a scenario Management has more weightage.
          </li>
          <li>Have any prior experience with Robots or Arduino.</li>
          <li>
            Miscellaneous i.e. Show us any skill that you might think CODE HIVES might
            be interested in.
          </li>
        </ul>
  ...
  },
  {
    title: (
      <>
        ...
        i.e. CODE HIVES. What should I do now ?
      </>
    ),
    body: (
      <>
  ...
  {
    title: (
      <>I am not from a CSE/IT Branch. Is CODE HIVES the right choice for me ?</>
    ),
    body: (
      <>
        There is <strong>“NO BRANCH RESTRICTION”</strong>, we have more than 10%
  ...
  {
    title: <>Is CODE HIVES an open club ?</>,
    body: (
      <>
        ...
        etc. , CODE HIVES got you covered.
        <br />
        There are some organizations/clubs you can be in along with CODE HIVES are:-
        <ul>
          <li>GDSC Club</li>
          <li>NSS Club</li>
          <li>SPORT Club</li>
  ...
  {
    title: <>Can a Non-Bitian become a member of CODE HIVES ?</>,
    body: (
      <>
        CODE HIVES is working towards making the community diverse and strong. We are
        going to come up with this idea very soon. Right now we are working
        towards the structure of CODE HIVES when Non-Bitian can join.
      </>
    ),
  },
  {
  ...
  {
    title: <>I don’t have a laptop. I am eligible to join CODE HIVES ?</>,
    body: (
      <>
        To prove your interest you don’t need a laptop definitely but we
        recommend that you buy a laptop within six months after joining GEC.
        Yes, you need a laptop to survive in CODE HIVES or else you will not be able
        to take the benefit of the community that CODE HIVES offers.
      </>
    ),
  },
  {
  ...
  {
    title: <>I want someone to mentor me. Can CODE HIVES help me ?</>,
    body: (
      <>
        <Link href="/teams">
          <a>CODE HIVES Team Page</a>
  ...
  {
    title: <>How big is CODE HIVES?</>,
    body: (
      <>
        <strong>9 letters big!!!</strong> Just kidding.
        <br />
        In terms of a team, we are being led by our Prof-in-Charge Dr. Sachin Makwana
        Sir along with students from all the years.
        <br />
  ...
  {
    title: <>What are some of the achievements of CODE HIVES ?</>,
    body: (
      <>
//         <ul>
//           <li>
...
//         </ul>
  ...
  {
    title: <>What is Linux ? Why do CODE HIVES members suggest Linux ?</>,
    body: (
      <>
        ...
        <br />
        <br />
        <strong>Long Answer</strong>:- CODE HIVES Members will always suggest you go
        ...
        written by one of our 2nd-year member, Zeeshan Ashraf at{' '}
        <a
          href=""
          target="_blank"
          rel="noreferrer"
  ...
  {
    title: <>What are the social handles of CODE HIVES ?</>,
    body: (
      <>
        <a
          href="https://twitter.com/code_hives"
          target="_blank"
          rel="noreferrer"
        >
         Twitter
  ...
  {
    title: <>We are an organization and we want to collab with CODE HIVES.</>,
    body: (
      <>
        Email us at <a href="mailto:code.hives@gecpatan.ac.in">code.hives@gecpatan.ac.in</a>{' '}
        or drop a message at our instagram page.
      </>
    ),
  },
];
