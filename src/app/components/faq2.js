export default function Faqs2() {
    return (
        <div className=" flex flex-col justify-between items-center w-full h-full box-border  bg-[#454345]" id="FAQ">
...
<ul className="max-w-2xl mx-auto mt-20 divide-y  items-center w-[100%] pl-3 pr-[55px] pt-7 pb-5  box-border     shadow-yellow-600 rounded-xl">
    <li>
        <details className="group">
            <summary className="flex items-center gap-3 px-4 py-3 font-medium marker:content-none hover:cursor-pointer bg-[#f6b112]">
                ...
                <span className="text-black">What am I getting as a Premium Member?</span>
            </summary>
